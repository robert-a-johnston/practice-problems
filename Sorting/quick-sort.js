...
// 4 Compare the element pointing with left pointer and if 
// it is less than the pivot element, then move the left 
// pointer to the right (add 1 to the left index). 
// 5 Continue this until left side element is greater 
// than or equal to the pivot element.
// 6 Compare the element pointing with right pointer and 
...
// 7 Check if left pointer is less than or equal to right 
// pointer, then swap the elements in locations of these pointers.
// 8 Increment the left pointer and decrement the right pointer.
// 9 If index of left pointer is still less than the index 
